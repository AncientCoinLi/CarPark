...
public class ParkingCashRender
{
    ...
    //add a controller here to manage this program
    ...
    public ParkingCashRender(Scene scene, GraphicsContext graphicsContext, Controller controller)
    {
        this.scene = scene;
        ...
        //TODO this is the start of simulation. if do not change this file, then modify the simulator
        startSimulation();
    }
    ...
    {
        new Thread(() -> unsafeParkingCashSimulator = new ParkingCashSimulator(slots, controller)).start();
    }
